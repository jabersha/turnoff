...
public class ConsultaPorSigla {
	public static void main(String[] args) {
			CidadeDAO dao = null;
		try {
			dao = new CidadeDAO();
//			List<Cidade> lista = CidadeBO.consultaPorSigla(JOptionPane.showInputDialog("SIGLA"));
			List<Cidade> lista = dao.consultaPorSigla(JOptionPane.showInputDialog("SIGLA"));
